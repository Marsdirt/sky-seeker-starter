...
export class LocalFileEvalStore {
    ...
    async delete(evalRunId) {
        ...
        return await unlink(filePath).then(() => this.deleteEvalRunFromIndex(evalRunId));
    }
    ...
    async deleteEvalRunFromIndex(evalRunId) {
        ...
        await writeFile(this.getIndexFilePath(), entries.join(this.INDEX_DELIMITER) + this.INDEX_DELIMITER);
    }
}
